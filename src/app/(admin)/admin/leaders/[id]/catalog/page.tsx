...
export default async function CatalogPage({
  ...
  // Verify admin belongs to the same org as this leader
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <Link href="/admin/leaders" className="font-body text-xs text-ink-faint hover:text-ink-mid mb-2 block">
          ← Leaders
        </Link>
      ...
      <div className="flex gap-1 bg-mist rounded-xl p-1 mb-8 w-fit">
        {TABS.map(t => (
          <Link
            key={t.id}
            href={`/admin/leaders/${params.id}/catalog?tab=${t.id}`}
